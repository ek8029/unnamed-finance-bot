...
export const V3_COPY = {
  ...
  firstLook: {
    ...
    largest: (t: string, pct: number) => `${t} is your largest position at ${pct}% of the book.`,
    heldIn: (t: string, n: number) => `${t} is held in ${n} of these accounts`,
    lineLabel: (t: string, n: number) => `${t} over its last ${n} closes`,
    noHistory: 'No price history for this name yet.',
    lineCaption: (n: number) => `Its last ${n} closes`,
