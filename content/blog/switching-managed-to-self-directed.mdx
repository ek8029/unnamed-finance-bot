...
seoTitle: "Switching From a Managed Portfolio to Self-Directed"
...
published: true
faq:
  - q: "How do you move from a managed account to a self-directed one?"
    a: "The mechanism is an ACATS transfer, initiated at the receiving broker rather than the one you are leaving. Positions generally move in kind, meaning the shares themselves transfer and no sale is triggered, so no capital gain is realized by the move. Proprietary funds a new broker cannot hold are the usual exception and may have to be liquidated first, which does realize gains."
  - q: "Will transferring my portfolio trigger capital gains tax?"
    a: "An in-kind transfer does not, because nothing is sold. Tax arises where positions have to be liquidated to move, which happens with proprietary or share-class-restricted funds, and where you rebuild the portfolio differently on the other side. Cost basis is supposed to follow the shares through the transfer, and confirming that it arrived correctly is worth doing before the next tax year."
  - q: "How long does an account transfer take?"
    a: "A full ACATS transfer is commonly quoted at roughly one to two weeks end to end, with the validation stage taking the first few business days. Positions are typically frozen while the transfer is in flight, so trading is unavailable during that window. Partial transfers and accounts holding unusual assets take longer."
  - q: "What breaks when you leave a managed portfolio?"
    a: "The services that ran quietly. Rebalancing stops. Any tax-loss harvesting the adviser was running stops. Concentration is no longer being watched as a position grows. Automatic contributions and withdrawal schedules need rebuilding at the new broker, and any held-away view the adviser maintained across your other accounts disappears with them."
  - q: "Should you sell everything before transferring?"
    a: "Selling first converts an untaxed in-kind move into a taxable event, so the default reason to do it is a position the receiving broker cannot hold rather than a preference about the portfolio. Rebuilding an allocation can be done after the transfer lands, where it can be spread across tax years and paired against harvested losses instead of realized all at once."
---
...
<CTACard title="Monitor your self-directed portfolio" description="Helm Terminal shows concentration risk, tax-loss harvesting opportunities, and earnings exposure across all your accounts: the intelligence layer most self-directed investors are missing." buttonText="Start free" href="/signup" />
