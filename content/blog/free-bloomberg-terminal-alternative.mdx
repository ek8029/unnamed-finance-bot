...
description: "Seven free Bloomberg Terminal alternatives, tested: what each free plan covers for research, charts and portfolio review, and where its limits bite."
date: "2026-05-12"
author: "Evan Kim"
...
faq:
  - q: "Is there a completely free Bloomberg Terminal?"
    a: "No. Bloomberg has no free or trial version; access starts around $24,000 per year. The free path for retail investors is to combine tools: Yahoo Finance and Finviz for data and screening, TradingView's free tier for charts, Koyfin's free tier for fundamentals, and Helm Terminal's free tier for portfolio intelligence."
  - q: "How can I get Bloomberg Terminal for free?"
    a: "Legitimately, only through some universities and a handful of public libraries that lease terminals for student and patron use. There is no free consumer version. For day-to-day retail needs, the free alternatives above cover most of what individuals actually use a terminal for."
...
|------|---------------|-------------------|-------------|-------------|-------------------|-------|
| **Helm Terminal** | Yes (holdings) | Full (via Plaid) | Yes | Yes | Headline loss figure free; tax lots and wash-sale screening on Pro | Free; Pro $20/mo or $149/year |
...
1. **Know what you own.** Total allocation across all accounts. Which positions are your largest. How concentrated you are in any single stock or sector, including the concentration that arrives through funds rather than direct holdings. Two funds with different tickers often hold the same companies at the top, which is what the free [ETF overlap tool](/tools/etf-overlap) checks.
...
Helm's free tier covers portfolio visibility, concentration, a general brief, and a headline harvestable-loss figure. Detailed tax analysis and earnings exposure require Pro. For item 4, Koyfin and Yahoo Finance handle company research. For charting and technical analysis, TradingView is best in class.
