...
<CTACard title="Try the free AI stock analysis" description="See the analysis engine on any ticker, no account required. Then connect your accounts to have Helm monitor your whole book." buttonText="Analyze a stock free" href="/analyze" />
...
<CTACard title="Have an AI analyst watch your portfolio" description="Helm monitors your holdings for risk, taxes, earnings, and broken theses, and shows its work. Free to start, read-only, no card required." buttonText="Open the terminal" href="/analyze" />
