...
faq:
  ...
  - q: "Is Helm's stock analysis free?"
    a: "Yes. Analysis on any US-listed stock or ETF is free and needs no account. Every figure comes from licensed market data and SEC EDGAR filings rather than from the model, and the narrative names its sources. What sits in Pro is the layer that runs against your own portfolio: thesis monitoring with cited evidence, earnings exposure and the tax center."
---
