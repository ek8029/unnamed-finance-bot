...
faq:
  ...
  - q: "How does Helm detect thesis drift?"
    a: "Positions carry written reasons, called pillars, each with a breaks-if condition. Helm reads SEC filings, earnings and news against those pillars every trading day and reports when one weakens or breaks, quoting the source sentence verbatim with its date and a link to the document. It also flags when separate holdings rest on the same pillar. Thesis monitoring is part of Helm Pro."
---
