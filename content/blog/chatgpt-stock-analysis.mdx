...
<CTACard title="See the grounded version" description="Helm's AI analysis on any US ticker, with real data and no account. Then connect your accounts to have it watch your whole portfolio." buttonText="Analyze a stock free" href="/analyze" />
