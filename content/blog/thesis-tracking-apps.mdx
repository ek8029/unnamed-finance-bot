...
faq:
  ...
  - q: "Which thesis tracking apps are actually available in 2026?"
    a: "As of August 2026, three automated thesis monitors are live: Helm Terminal (free to start, $20/month Pro for the thesis layer on unlimited holdings), MyThesis ($4.99 per holding per month, first holding free), and ThesisLoop ($60/year or $200/year). Vela is in private waitlist, Thesis (usethesis.com) is in early access, and newer entrants like thesisai.app and subthesis.app cover thesis generation and journaling rather than monitoring."
