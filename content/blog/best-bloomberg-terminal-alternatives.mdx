...
<CTACard title="Try the free AI stock analysis" description="Get institutional-grade analysis for any ticker — no account required." buttonText="Analyze a stock" href="/analyze" />
