...
<CTACard title="Helm scans for harvestable losses nightly" description="Helm Pro adds tax-loss harvesting, earnings exposure, and thesis monitoring for $20 a month, or $149 a year. Free to start." buttonText="Start free" buttonLink="/signup" />
...
Pro is $20 a month, or $149 a year.

<CTACard title="Take the Helm" description="Portfolio intelligence, not just another tracker. Free to start. Pro is $20 a month." buttonText="Open the terminal" buttonLink="/signup" />
