...
<CTACard title="See your real net worth" description="Link every account. One number. Updated automatically. Read-only, through Plaid." buttonText="Open the terminal" href="/signup" />
...
<CTACard title="Helm scans for harvestable losses nightly" description="Helm Pro adds tax-loss harvesting, earnings exposure, and thesis monitoring for $20 a month, or $149 a year. Free to start." buttonText="Start free" href="/signup" />
...
<CTACard title="Read today's market brief" description="What moved, what matters, what's next. Updated every 5 minutes. No signup required." buttonText="Read today's brief" href="/brief" />
...
<CTACard title="Take the Helm" description="Portfolio intelligence, not just another tracker. Free to start. Pro is $20 a month." buttonText="Open the terminal" href="/signup" />
