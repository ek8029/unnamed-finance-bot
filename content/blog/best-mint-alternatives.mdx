...
**Mint's competitors outlived it.** Monarch, Copilot and Simplifi sold against Mint while it was free and charge a subscription for the budgeting side; Empower stays free by selling advisory services. Neither is Mint's ad model, which is the point. Kubera sits at the edge of the list for people whose problem is net worth rather than budgets. The current terms are below.
...
| Helm | $149/year, $20/mo flat | Portfolio intelligence, not budgeting |
...
Helm is $20 a month flat, or $149 a year, with no percentage of assets and no free tier that monetises your attention. The free tier gives you the terminal, net worth across linked accounts, and analysis on any US ticker without an account. Tax-loss harvesting is part of Pro.
