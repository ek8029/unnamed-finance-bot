...
seoTitle: "Self-Directed Investing: A Plain Guide"
...
faq:
  - q: "What is self-directed investing?"
    a: "Self-directed investing means choosing and placing your own trades in an account you control, rather than delegating those decisions to an adviser or a managed portfolio. The account is ordinarily a standard taxable brokerage account or an IRA. What transfers to you along with the control is the record keeping, the tax reporting decisions and the risk monitoring that a managed service performed in the background."
  - q: "Is self-directed investing worth it?"
    a: "The measurable saving is the fee. A 1 percent advisory fee on $500,000 is $5,000 a year, and it recurs whether the year was good or bad. The cost side is the work that fee covered: rebalancing, tax-loss harvesting, keeping concentration in view and holding a plan through a drawdown. Self-directing pays when that work actually happens, and is expensive when it quietly does not."
  - q: "What do you lose when you leave an adviser?"
    a: "Mostly the parts that were invisible. Automatic rebalancing stops. Tax-loss harvesting stops unless you run it. Nobody is watching concentration build in a position that has been rising, and nobody is between you and a decision made in a bad week. The portfolio itself usually transfers intact through an ACATS transfer; the process around it does not transfer with it."
  - q: "How much time does self-directed investing take?"
    a: "Less than most people expect for maintenance and more than most expect at the decision points. A broadly indexed portfolio needs attention a few times a year for contributions and rebalancing. Individual positions need a reason to be held and something that would change that reason, which is work at purchase and at each report rather than daily monitoring."
  - q: "What should a self-directed investor track?"
    a: "The items an adviser was tracking on your behalf. Single-name and sector concentration measured after looking through funds to their holdings. Unrealized losses by lot, with the wash-sale window applied across every account. Earnings dates on positions actually held. And the reason each position is owned, written down, with the fact that would end it."
  - q: "What does Helm do for a self-directed investor?"
    a: "Helm connects brokerage and retirement accounts read-only through Plaid and runs the monitoring layer continuously: concentration with fund look-through, unrealized losses lot by lot with wash-sale windows screened across accounts, earnings dates on held positions, and filings and news read against the stated reason for each holding, quoted with a date. Helm is not a registered investment adviser, cannot trade and cannot move money."
---
