...
<CTACard title="Try the free AI stock analysis" description="Get a fresh read on any US ticker, no account required. Then connect your accounts to have Helm watch your whole portfolio." buttonText="Analyze a stock free" href="/analyze" />
...
<CTACard title="Have an AI analyst watch your portfolio" description="Helm monitors your holdings for risk, taxes, earnings, and broken theses, and shows its work. Free to start, read-only." buttonText="Open the terminal" href="/analyze" />
