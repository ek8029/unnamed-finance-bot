...
seoTitle: "Wealth Management for Tech Workers: RSUs and More"
description: "RSUs vesting, ISO decisions, 40% of net worth in one stock. The playbook for tech employees managing $200K-$2M without a wealth advisor."
date: "2026-03-20"
updated: "2026-09-24"
author: "Evan Kim"
...
published: true
faq:
  - q: "What should tech workers do about concentrated employer stock?"
    a: "The first step is measuring the true position, which means adding vested shares, unvested RSUs on their vesting schedule, any ESPP holdings and the exposure carried indirectly through index funds that already hold the employer. The reason this matters more for tech workers is correlation with income: the salary and the position depend on the same company, so a bad year arrives in both at once."
  - q: "How are RSUs taxed for tech employees?"
    a: "As ordinary income at vest, on the fair market value of the shares that vest, included in Box 1 of the W-2. Employers commonly withhold at the flat 22 percent supplemental rate, which under-withholds for anyone in a higher bracket and produces a balance at filing. The vest-day value becomes the cost basis, so only the change after vest is a capital gain or loss."
  - q: "What is the difference between RSUs, ISOs and NSOs?"
    a: "RSUs are shares delivered at vest and taxed as ordinary income then. Non-qualified stock options are taxed as ordinary income on the spread at exercise. Incentive stock options are not taxed as ordinary income at exercise but the spread is an alternative minimum tax preference item, and holding long enough after exercise and grant can make the eventual sale entirely long-term. The three carry different timing, so they are rarely handled the same way."
  - q: "Should tech workers max out their ESPP?"
    a: "The mechanical value is the discount plus any lookback, and that is realized at purchase rather than at sale. The consideration specific to this group is that an ESPP adds employer stock to a balance sheet that is usually already heavy in it, on top of RSUs and salary from the same company, so the discount and the added concentration are being weighed against each other."
  - q: "How much of net worth should be in one employer's stock?"
    a: "No threshold is defined in law and the honest input is the arithmetic plus the correlation. A position at 40 percent of net worth falling by half takes 20 percent off the total, and for an employee that decline tends to coincide with hiring freezes and reduced future grants at the same firm. That overlap, rather than the percentage alone, is what makes employer concentration different from any other."
---
