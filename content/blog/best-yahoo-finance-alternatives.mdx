...
faq:
  ...
  - q: "How is Helm different from Yahoo Finance?"
    a: "Yahoo Finance is a market data and news site organized around tickers. Helm connects to brokerage accounts read-only through Plaid and is organized around the positions you actually hold, reporting concentration including look-through into ETFs, upcoming earnings on those positions, and the reasons behind each holding tested against filings and news. Helm is free to start; the tax center, earnings exposure and thesis monitoring are part of Pro."
---
