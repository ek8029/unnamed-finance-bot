...
description: "8 free tools tested. Only 3 show real portfolio risk, not just holdings. Here's what each actually does and where they fall short."
date: "2026-04-02"
author: "Evan Kim"
...
updated: "2026-09-15"
faq:
  - q: "What is the best free portfolio analysis tool?"
    a: "Most free tools only track holdings and value. The few that show real risk (concentration, sector exposure, and tax opportunities) are more useful for decisions. Helm Terminal is free to start, connects your accounts read-only, and surfaces portfolio risk rather than just a balance."
  - q: "Can I analyze my portfolio for free?"
    a: "Yes. Several tools let you analyze a portfolio at no cost. Helm Terminal connects your brokerage accounts through Plaid (read-only) and covers net worth, holdings and concentration risk on its free tier. The tax center with tax-loss harvesting and earnings exposure tracking are part of Pro, at $20 a month or $149 a year."
  - q: "What is the difference between a portfolio tracker and portfolio analysis?"
    a: "A tracker shows what you own and what it is worth. Portfolio analysis goes further: it measures concentration risk, sector exposure, correlation, and tax opportunities, and tells you what actually needs attention. Many free tools track; far fewer analyze."
---
...
A portfolio built from several funds can be far more concentrated than the ticker count suggests, because cap-weighted funds land on the same large companies at the top. Comparing two funds is the quickest version of that check: the free [ETF overlap tool](/tools/etf-overlap) reports which companies two funds both hold and the share of each fund sitting in those names. It reads the ten largest holdings of each fund, so the figure is a floor on the real overlap rather than the total.

## Four free calculators to run alongside

A portfolio tool shows you what you hold. These answer the specific questions that follow, each in under a minute, none of them needing an account:

- [Tax-loss harvesting calculator](/tools/tlh-calculator): what harvesting your current losses would be worth this year, given your bracket and realized gains.
- [Wash sale calculator](/tools/wash-sale-calculator): how much of a loss the wash sale rule disallows for a sale you are weighing, and what the replacement shares' basis becomes.
- [ETF overlap tool](/tools/etf-overlap): which companies two funds both hold among their ten largest positions, and the share of each fund sitting there.
- [RSU tax calculator](/tools/rsu-calculator): the tax due at vest, take-home after withholding, and how concentrated one employer's stock leaves you.
- [Capital gains tax calculator](/tools/capital-gains-calculator): the federal tax on a gain with the 2026 brackets, slice by slice, including the 3.8 percent net investment income tax.
- [Dividend income calculator](/tools/dividend-income-calculator): year-by-year dividend income and portfolio value from yield, dividend growth, price growth and contributions, with or without reinvestment.
- [Portfolio beta calculator](/tools/portfolio-beta-calculator): the weighted-average beta of a book from each holding's value and beta, with cash at zero, and what a 1, 5 or 10 percent index move implies.
- [Monte Carlo retirement calculator](/tools/monte-carlo-retirement-calculator): a seeded simulation of a retirement plan, with the success rate, percentile balances and a five-year band, and a plain statement of what the model leaves out.

Each one prints its own limits next to the figure. A calculator that is a floor, an estimate, or a single-lot case says so on the page.
...
- [AI Stock Analysis — Try Free](/analyze)
