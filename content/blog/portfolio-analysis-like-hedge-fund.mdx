---
title: "I Analyzed My Portfolio Like a Hedge Fund. Here's What I Found."
seoTitle: "I Analyzed My Portfolio Like a Hedge Fund"
description: "Portfolio analysis like a hedge fund: most investors just check green or red. Here is what professional-grade screens found on one real portfolio."
date: "2026-04-04"
author: "Evan Kim"
tags: ["investing", "portfolio-analysis", "tax-loss-harvesting", "risk-management"]
published: true
faq:
  - q: "What analysis do hedge funds run that retail investors do not?"
    a: "Little of it is exotic. The routine items are exposure decomposition, which asks what the book is actually long after netting; factor tilts toward value, growth, momentum and size; correlation between positions rather than their count; stress tests against defined scenarios; and a written thesis per position with the condition that would end it. None of that requires institutional data, and most of it is absent from retail tools by omission rather than difficulty."
  - q: "How do you analyze your own portfolio properly?"
    a: "Start from combined holdings across every account, with funds looked through to their underlying companies. From that single view compute single-name and sector weight, identify positions that move together, list unrealized losses by lot with wash-sale windows applied across accounts, map earnings dates onto held positions, and write down why each position is owned and what would falsify it."
  - q: "What is factor exposure?"
    a: "Factors are shared characteristics that explain a large part of why groups of stocks move together, the common ones being value, growth, momentum, size and quality. A portfolio of thirty apparently different companies can carry one dominant tilt, which is why it falls together in a rotation. Factor exposure describes the bet the book is making beyond the individual names in it."
  - q: "What is a stress test for a portfolio?"
    a: "Applying a defined shock and reading the dollar result rather than the percentage. A 20 percent decline in the largest holding, a rate move against long-duration positions, a sector-wide derating. The output is the loss in money at current weights, which is the form most people can actually evaluate against their circumstances."
  - q: "Can retail investors get institutional-grade portfolio analysis?"
    a: "The inputs are largely public now. Filings are free on SEC EDGAR, fund holdings are published, and market data is inexpensive. What was institutional was the plumbing that assembled it across accounts and kept it current. Helm connects accounts read-only and runs concentration with fund look-through, tax-lot analysis, earnings mapping and thesis monitoring against dated primary sources."
---
...
## 42% of My Portfolio Was in Three Stocks
...
## $2,800 in Tax Losses Just Sitting There
...
## Half My Portfolio Was Reporting Earnings in the Same Week
...
## My "Tech Diversification" Was a Lie
...
<CTACard title="Run these screens on your portfolio" description="Helm Terminal connects to your brokerage accounts and runs concentration, tax-loss, earnings exposure, and sector analysis automatically. Free to start." buttonText="Try Helm Terminal" href="/signup" />

If you want to start small, the [free stock analysis tool](/analyze) lets you run an AI-powered screen on any US stock. No signup, no paywall. Just type in a ticker and see the breakdown.
