...
export default function HelmHome({ latestCatch, tickerTape }: { demoAnalyses: unknown[]; tickerTape: TickerTapeItem[]; latestCatch?: Catch | null }) {
  ...
  return <div className="helm-home">
    ...
    <main id="main-content">
      ...
      <section id="terminal" className="helm-terminal-stage helm-width" aria-label="Explore the Helm terminal">
        ...
        <div id="feature-preview" role="tabpanel" aria-labelledby={`feature-tab-${view}`} className="helm-product-image">
      ...
      <section className="helm-section helm-width helm-value-section">
        ...
        <div className="helm-value-grid">
          <article className="helm-value-primary"><span className="helm-label">THE THESIS BEHIND THE TICKER</span><h3>You had a reason<br />to buy. Is it still true?</h3><p>Helm checks the pillars of your investment thesis against SEC filings, earnings and news. When the evidence changes, you get the source.</p><Link href="/thesis-monitoring" className="helm-text-link">How thesis monitoring works <ArrowUpRight size={17} /></Link><div className="helm-thesis-diagram" aria-label="Monitoring process"><span>Your investment thesis</span><i /><span>Filings · Earnings · News</span><i /><strong>What changed, with evidence <ArrowRight size={17} /></strong></div></article>
