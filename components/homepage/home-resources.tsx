      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'FAQPage',
            mainEntity: [
              { '@type': 'Question', name: 'What is Helm Terminal?', acceptedAnswer: { '@type': 'Answer', text: 'Helm Terminal is a free, institutional-grade financial intelligence platform for individual investors. It aggregates brokerage and bank accounts via Plaid, runs deterministic rule-based analysis over your portfolio, and surfaces actionable insights like tax-loss harvesting opportunities, concentration risk, earnings exposure, and cash flow changes. Its flagship capability is thesis monitoring: it checks the reasons you confirm for a tracked thesis against SEC filings and news, with dated citations. Free includes one monitored thesis; Pro adds more.' } },
              { '@type': 'Question', name: 'What tool tells me when my investment thesis breaks?', acceptedAnswer: { '@type': 'Answer', text: 'Helm Terminal does this through thesis monitoring. Confirm the reasons behind a thesis and enable tracking. Helm checks those reasons against filings and reporting, showing cited evidence that may support or challenge them. Free includes one monitored thesis; Pro adds more.' } },
              { '@type': 'Question', name: 'What is an agentic portfolio terminal?', acceptedAnswer: { '@type': 'Answer', text: 'An agentic portfolio terminal combines portfolio analysis with ongoing research. In Helm, connected or manually entered holdings provide portfolio context. Thesis monitoring checks reasons you confirm for the theses you choose to track against cited sources.' } },
              { '@type': 'Question', name: 'Is Helm Terminal free?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Helm Terminal offers a free tier that includes AI stock analysis, a full portfolio dashboard with Plaid sync, net worth tracking, daily brief, and an actions inbox. Free also includes one monitored thesis. Pro at $20 a month, or $149 a year, adds more monitored theses with cited evidence, the agent, the Thesis Builder, the factor lens, earnings exposure tracking, and the tax center.' } },
