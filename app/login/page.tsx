          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label htmlFor="password" className="block font-mono text-[10px] font-semibold uppercase tracking-[0.18em] text-[#9A9A9A]">
                  Password
                </label>
                <Link
            ...
            <div className="flex items-center">
              <label htmlFor="remember-me" className="flex items-center gap-2 text-[15px] text-[var(--color-text-secondary)] cursor-pointer py-1">
                <input
                  ...
                  className="w-4 h-4 rounded border-white/[0.10] bg-[var(--color-bg-inset,#060606)] text-[var(--color-gold)] focus:ring-[var(--color-gold)]/30 focus:ring-offset-0 cursor-pointer accent-[var(--color-gold)]"
                />
                Remember me
              </label>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 px-4 bg-[var(--color-gold)] hover:bg-[var(--color-gold-hi)] disabled:opacity-50 text-[#0A0A0A] font-semibold rounded-md transition-colors flex items-center justify-center gap-2"
            >
              {loading ? 'Signing in...' : (
                <>
                  Sign in
