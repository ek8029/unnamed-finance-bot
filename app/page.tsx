...
/* ─────────────────────────────────────────
   ...
   ───────────────────────────────────────── */
function WaitlistForm({ id, defaultRef }: { id: string; defaultRef?: string }) {
...
/* ─────────────────────────────────────────
   Landing Page (inner, reads search params)
   ───────────────────────────────────────── */
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
          ...
          <AnimatedSection delay={0}>
            <div className="space-y-6">
              ...
              <WaitlistForm id="hero-email" defaultRef={refCode} />
      ...
      <section className="relative container mx-auto px-6 pb-24">
        <AnimatedSection>
          <div className="max-w-xl mx-auto text-center space-y-6">
            ...
            <WaitlistForm id="footer-email" defaultRef={refCode} />
          </div>
        </AnimatedSection>
      </section>
