...
// Format raw Plaid category names like "FOOD_AND_DRINK" -> "Food & Drink"
...
// Guess a category group from a raw Plaid category name
function guessCategoryGroup(raw: string): string {
