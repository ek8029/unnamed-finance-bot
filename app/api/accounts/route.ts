...
export async function GET() {
  try {
    ...
    const transformedAccounts = accounts.map(account => ({
      ...
      // Reported account balance, not the market-priced holdings valuation.
      // Missing balances remain null through the API and account UI.
      balance: reportedAccountBalance(account),
