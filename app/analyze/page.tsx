...
export default async function AnalyzePage() {
  ...
  // ── Authenticated: render inside dashboard shell (layout provides sidebar) ──
  if (user) {
    return (
  ...
  // ── Anonymous: full standalone page (SEO landing) ──
  return (
      ...
      <nav className="relative z-10 glass-nav">
        <div className="container mx-auto px-6 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-5">
            <Link href="/analyze" className="text-sm text-[var(--color-text-primary)] font-medium transition-colors">
              Analyze
            </Link>
