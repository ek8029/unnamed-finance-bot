...
export const alt = 'Free Stock Analysis — Helm Terminal';
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ position: 'relative', marginTop: 24, fontSize: 28, fontWeight: 600, color: '#8A94A6', letterSpacing: '0.1em', textTransform: 'uppercase' }}>Free Stock Analysis</div>
      </div>
    ),
    { ...size },
  );
