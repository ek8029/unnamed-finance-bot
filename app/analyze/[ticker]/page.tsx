        ...
        <main className="relative z-10 flex-1 flex items-center justify-center px-6">
          <div className="text-center space-y-5 max-w-md">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              ...
              <a
                href="/analyze/AAPL"
                className="px-5 py-2 border border-[var(--color-border-base)] text-[var(--color-text-secondary)] hover:text-[var(--color-text-primary)] text-[14px] font-medium rounded transition-colors"
              >
                See an example (AAPL)
              </a>
            </div>
      ...
      <main className="relative z-10 flex-1 w-full max-w-[1800px] mx-auto px-3 sm:px-4 lg:px-6 py-6">
        ...
        <section className="mt-8 space-y-6 border-t border-[var(--color-border-subtle)] pt-6 max-w-3xl mx-auto">
          ...
          {faqs.map((f, i) => (
            <div key={i} className="space-y-1.5">
              <h3 className="text-[15px] font-semibold text-[var(--color-text-primary)]">{f.question}</h3>
        ...
        <section className="mt-8 border-t border-[var(--color-border-subtle)] pt-6 max-w-3xl mx-auto">
          <details className="group">
            <summary className="cursor-pointer list-none flex items-center justify-between text-[14px] font-semibold text-[var(--color-text-primary)] hover:text-[var(--color-gold)] transition-colors">
            ...
            <div className="mt-4 space-y-3 text-[13px] text-[var(--color-text-secondary)] leading-relaxed">
              <div>
              ...
              <div>
                ...
                <dd className="inline">Helm AI v{methodologyVersion}</dd>
              </div>
              <p>
          ...
          <div className="flex flex-wrap gap-2">
            {related.map(t => (
              <a
                key={t}
                href={`/analyze/${t}`}
                className="px-3 py-1.5 text-[13px] font-mono font-medium text-[var(--color-text-secondary)] border border-[var(--color-border-base)] rounded hover:border-[var(--color-gold)] hover:text-[var(--color-gold)] transition-colors"
              >
                {t}
              </a>
            ))}
