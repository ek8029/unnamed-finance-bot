...
export const alt = 'Simple, Transparent Pricing — Helm Terminal';
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <img src={logoBase64} width={160} height={160} alt="" style={{ position: 'relative' }} />
        <div style={{ position: 'relative', marginTop: 24, fontSize: 28, fontWeight: 600, color: '#8A94A6', letterSpacing: '0.1em', textTransform: 'uppercase' }}>Simple, Transparent Pricing</div>
      </div>
    ),
    { ...size },
  );
