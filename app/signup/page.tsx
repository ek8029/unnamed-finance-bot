  ...
  return (
    <AuthShell subtitle={isWrappedFlow ? "Create your account to see your Wrapped" : "Create your account"}>
      ...
      <button type="button" onClick={handleGoogleSignIn}
        className="w-full py-3 px-4 bg-transparent border border-white/[0.10] hover:border-white/[0.20] text-[var(--color-text-secondary)] hover:text-[var(--color-text-primary)] font-medium rounded-md transition-colors flex items-center justify-center gap-3 focus:outline-none focus:border-[var(--color-gold)]">
      ...
      <div className="relative my-6">
        ...
        <div className="relative flex justify-center"><span className="px-3 bg-[var(--color-bg-surface,#131313)] font-mono text-[10px] uppercase tracking-[0.18em] text-[#6A6A6A]">or</span></div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          <label htmlFor="email" className="block font-mono text-[10px] font-semibold uppercase tracking-[0.18em] text-[#9A9A9A] mb-2">Email</label>
        ...
        <div>
          <label htmlFor="password" className="block font-mono text-[10px] font-semibold uppercase tracking-[0.18em] text-[#9A9A9A] mb-2">Password</label>
          <div className="relative">
            <input id="password" type={showPassword ? 'text' : 'password'} value={password} onChange={(e) => setPassword(e.target.value)} required autoComplete="new-password"
              className="w-full px-4 py-3 pr-12 bg-[var(--color-bg-inset,#060606)] border border-white/[0.07] rounded-md text-[var(--color-text-primary)] placeholder-[var(--color-text-muted)] focus:outline-none focus:border-[var(--color-gold)] transition-colors"
