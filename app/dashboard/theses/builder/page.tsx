...
function Eyebrow({ children }: { children: React.ReactNode }) {
  return (
    <div
      className="font-mono text-[12px] font-semibold uppercase tracking-[0.2em] text-[var(--color-gold)]"
      style={MONO}
    >
      {children}
    </div>
...
function RiskHeading({ children }: { children: React.ReactNode }) {
  return (
    <div
      className="font-mono text-[12px] font-semibold uppercase tracking-[0.16em] text-[var(--color-text-secondary)]"
      style={MONO}
    >
      {children}
    </div>
